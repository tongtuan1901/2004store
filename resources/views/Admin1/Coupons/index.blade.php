                        ...
                        <div class="row mg-top-30">
                            <div class="col-12 sherah-flex-between">
                                ...
                                <div class="sherah-breadcrumb">
                                    <h2 class="sherah-breadcrumb__title">Danh sách khuyến mãi</h2>
                                    
                                </div>
                                <!-- End Sherah Breadcrumb -->
                                <a href="{{ route('admin-coupons.create') }}" class="sherah-btn sherah-gbcolor">Thêm khuyến mãi</a>
                            </div>
                        </div>
                            ...
                            <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                ...
                                <thead class="sherah-table__head">
                                    <tr>
                                        ...
                                        <th class="sherah-table__column-2 sherah-table__h2">Mã khuyễn mãi</th>
                                        <th class="sherah-table__column-3 sherah-table__h3">Loại</th>
                                        <th class="sherah-table__column-4 sherah-table__h4">Số tiền giảm</th>
                                        <th class="sherah-table__column-5 sherah-table__h5">Danh mục</th>
                                        <th class="sherah-table__column-6 sherah-table__h6">Sản phẩm</th>
                                        <th class="sherah-table__column-7 sherah-table__h7">Giá gốc</th>
                                        <th class="sherah-table__column-8 sherah-table__h8">Giá sau khi giảm</th>
                                        <th class="sherah-table__column-9 sherah-table__h9">Thời gian bắt đầu</th>
                                        <th class="sherah-table__column-10 sherah-table__h10">Thời gian kết thúc</th>
                                        <th class="sherah-table__column-11 sherah-table__h11">Thao tác</th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                            <div class="sherah-language-form__input">
                                                <p class="crany-table__product--number">{{ $index + 1 }}</p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="sherah-table__column-5 sherah-table__data-5">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">{{ $coupon->value }}</p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="sherah-table__column-5 sherah-table__data-5">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">{{ $coupon->product ? $coupon->product->name : 'N/A' }}</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-5 sherah-table__data-5">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">{{ number_format($coupon->original_price) }} VNĐ</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-5 sherah-table__data-5">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">{{ number_format($coupon->discounted_price) }} VNĐ</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-5 sherah-table__data-5">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">{{ $coupon->starts_at }}</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-5 sherah-table__data-5">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">{{ $coupon->expires_at }}</p>
                                            </div>
                                        </td>
