                        ...
                        <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                            <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                ...
                                <thead class="sherah-table__head">
                                    <tr>
                                        <th class="sherah-table__column-1 sherah-table__h1">Số thứ tự</th>
                                        <th class="sherah-table__column-2 sherah-table__h2">Tiêu đề</th>
                                        <th class="sherah-table__column-3 sherah-table__h3">Nội dung</th>
                                        <th class="sherah-table__column-4 sherah-table__h4">Ảnh</th>
                                        <th class="sherah-table__column-4 sherah-table__h4">Thao tác</th>
                                        {{-- <th class="sherah-table__column-5 sherah-table__h5">Đến ngày</th>
                                    ...
                                    <tr>
                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                            <div class="sherah-language-form__input">
                                                <p class="crany-table__product--number">{{$item->id}}</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                            <div class="sherah-language-form__input">
                                        ...
                                        <td class="sherah-table__column-4 sherah-table__data-4">
                                            <div class="sherah-table__product-content">
                                                <div
                                                    ...
                                                    <img src="{{ Storage::url($item->image) }}" alt="" width="150" height="100"></div>
                                            </div>
                                        </td>                                        
                                        <td class="sherah-table__column-8 sherah-table__data-8">
                                            <div class="sherah-table__status__group">
                                                ...
                                                <form action="{{ route('new.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
