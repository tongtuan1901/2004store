        ...
        <div class="main-collection" data-id="3447590">
            ...
            <div class="container">
                ...
                <div class="main-collection-wrap vertical">
                    <div class="container">
                        <h1 class="titleStyle1">Danh mục {{$selectedCategory->name}} của chúng tôi</h1>
                        ...
                        @endif
                                            ...
                                            <div class="product-item-actions">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            @if (auth()->check())
                                                                <form action="{{ route('cart.add') }}" method="POST">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="size-best-{{ $product->id }}">Kích
                                                                            thước:</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="color-best-{{ $product->id }}">Màu
                                                                            sắc:</label>
                                                ...
                                                <button class="ft4" style="background-color: #4CAF50 ; color: white">
                                                    <a href="{{ route('client-products.show', $product->id) }}">Xem chi
                                                        tiết</a>
                                                </button>
                                            </div>
                                        ...
                                        <div class="product-item-details">
                                            ...
                                            <h2 class="product-item-name" style="font-size: 0.8em; font-weight: 500;"><a
                                                    href="{{ route('client-products.show', $product->id) }}">{{ $product->name }}</a>
