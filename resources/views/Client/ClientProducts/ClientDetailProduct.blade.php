...
<<<<<<< HEAD
                            <a href="#" onclick="return false;" aria-label="Áo Dây TWIST DRAPE"
                                        ...
                                        href="https://wa.me/?text=https://f1genz-model-fashion.mysapo.net/ao-day-twist-drape"><svg
                                            ...
                                            <defs>
                                                <linearGradient gradientTransform="matrix(0 -512 -512 0 256.001 512)"
                                                    gradientUnits="userSpaceOnUse" id="whatsApp_svg___Linear1"
                                                    x1="0" x2="1" y1="0" y2="0">
...
<<<<<<< HEAD
                        ...
                        <div class="d-none">
                            <select id="main-product-select" name="id">
                                <option value="120912733">Kem / S</option>
                                <option value="120912734">Kem / M</option>
                                <option value="120912735">Kem / L</option>
                            </select>
                        </div>
                        ...
                        <div class="main-product-cta">
                            ...
                            <button type="button" data-type="main-product-send-info"
                                onclick="window.open('pages/lien-he.html')" title="Liên hệ">
                            ...
                            <div class="product-item-wrap">
                                ...
                                <div class="product-item-detail">
                                    ...
                                    <h3 class="product-item-detail-title"><a href="ao-phong-co-chu-v-logo-rosy.html"
                                            ...
                                            aria-label="&#193;O PH&#212;NG CỔ CHỮ V LOGO ROSY">ÁO PHÔNG CỔ CHỮ V LOGO
                                            ROSY</a></h3>
