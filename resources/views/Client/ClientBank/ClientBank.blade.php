...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="qr-section">
            ...
            <p class="warning">Chú ý: Quét mã QR MB Bank không tự điền nội dung chuyển tiền, vui lòng nhập lại chính xác theo nội dung dưới đây</p>
            <div class="qr-code">
            ...
            <span class="value transfer-content" id="transfer-content-{{ $index }}">{{ $transferContents[$index] }}</span>
        ...
        <div class="card-section">
            ...
            <div class="info-row">
                ...
                <span class="value account-name" id="account-name-{{ $index }}">{{ $bankCard->account_holder_name }}</span>
                <button class="copy-button">Sao chép</button>
            </div>
            <div class="info-row">
                <span class="label">Số thẻ</span>
                <span class="value card-number" id="card-number-{{ $index }}">{{ $bankCard->card_number }}</span>
                <button class="copy-button">Sao chép</button>
            </div>
            <div class="info-row">
                <span class="label">Nội dung chuyển khoản</span>
    ...
    <div class="instructions">
        ...
        <ol>
            ...
            <li>Nhập số tiền muốn nạp, kiểm tra thông tin đơn hàng (NH, chủ TK, số TK, Nội dung CK) trùng khớp với thông tin CK bên trái.</li>
    ...
    <div class="alert-box">
        ...
        <ul>
            <li><strong>Chú ý:</strong> Tài khoản bank không cố định. Vui lòng kiểm tra lại tên và số tài khoản đang hiển thị trước khi thực hiện giao dịch. Xin cảm ơn.</li>
            ...
            <li>- Quý khách thực hiện chuyển tiền qua dịch vụ quốc tế tới ngân hàng Việt Nam vui lòng chờ từ 3-5 ngày (tùy vào dịch vụ / không tính Thứ 7 và Chủ Nhật)</li>
        </ul>
    </div>
