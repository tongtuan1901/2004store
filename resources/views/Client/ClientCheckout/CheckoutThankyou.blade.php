                                                ...
                                                <tbody>
                                                    @foreach ($order->orderItems as $item)
                                                        <tr class="product">
                                                            ...
                                                            <th class="product__quantity printable-only">x
                                                                {{ $item->quantity }}</th>
                            ...
                            <div class="col col--primary">
                                    ...
                                    <div class="section__content section__content--bordered">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col col--md-two">
                                                ...
                                                <p>{{ $order->shipping_method ?? 'Giao hàng tận nơi' }}</p>
                                            </div>
                                        </div>
                                ...
                                <section class="section unprintable">
                                    <div class="field__input-btn-wrapper field__input-btn-wrapper--floating">
                                        <a data-savepage-href="/" href="{{ route('client-home.index') }}"
