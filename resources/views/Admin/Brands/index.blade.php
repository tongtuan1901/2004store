                                    ...
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                ...
                                                <th class="sherah-table__column-2 sherah-table__h2">Tên thương hiệu</th>
                                        ...
                                        <tbody class="sherah-table__body">
                                            @forelse ($listBrands as $key => $brand)
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__vendor">
                                                            <h4 class="sherah-table__vendor--title">{{ $brand->name }}</h4>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="sherah-table__product-content">
                                                            @if ($brand->image)
                                                                <img src="{{ asset('storage/' . $brand->image) }}"
                                                                    alt="Brand Image" class="w-20 h-20 object-cover">
                                                            @else
                                                                    ...
                                                                    <svg class="sherah-color2__fill"
                                                                        ...
                                                                        <g id="Icon"
                                                                            ...
                                                                            <path id="Path_486" data-name="Path 486"
                                                                                d="M225.582,107.622c0,.9,0,1.806,0,2.709a.806.806,0,0,1-.882.815c-.5,0-.912-.393-.915-.867s0-1.66,0-2.465c0-.472.398-.865.887-.866.465,0,.879.405.882.875C225.582,107.806,225.582,107.713,225.582,107.622Z"
                                                                                transform="translate(-50.204 -66.006)" />
                                                                        </g>
                                                                    </svg>
                                                                </button>
                                                            </form>
