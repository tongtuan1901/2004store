                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="sherah-breadcrumb mg-top-30">
                                    <h2 class="sherah-breadcrumb__title">Quản lí nhân viên</h2>
                                </div>
                                <div class="mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                    <a href="{{ route('user-staff.create') }}" class="btn btn-primary">Thêm nhân viên mới</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                        <!-- <a href="{{ route('user-staff.edit', $user->id) }}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                        ...
                                                        <form action="{{ route('user-staff.destroy', $user->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="sherah-table__action sherah-color2 sherah-color2__bg--offset" onclick="return confirm('Bạn có chắc chắn muốn xóa nhân viên này?')">
