                        ...
                        <div class="sherah-dsinner">
                            <div class="row mg-top-30">
                                <div class="col-12 sherah-flex-between">
                                    ...
                                    <a href="{{ route('admin-coupons.create') }}" class="sherah-btn sherah-gbcolor">Thêm
                                        khuyến mãi</a>
                                </div>
                            </div>
                                        ...
                                        @foreach ($coupons as $index => $coupon)
                                            <tr>
                                                ...
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">
                                                            {{ $coupon->product ? $coupon->product->name : 'N/A' }}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">
                                                            {{ number_format($coupon->original_price) }} VNĐ</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">
                                                            {{ number_format($coupon->discounted_price) }} VNĐ</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                    ...
                                                    <div class="sherah-table__status__group">
                                                        ...
                                                        <form action="{{ route('admin-coupons.destroy', $coupon->id) }}"
                                                            ...
                                                            <button
                                                                ...
                                                                type="submit"><svg class="sherah-color2__fill"
