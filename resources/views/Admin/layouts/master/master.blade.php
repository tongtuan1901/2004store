...
<div
    ...
    <div
        ...
        <a href="index.html" class="logo">
            <span>
                <img src="assets/images/2004Store.png" alt="logo-small" class="logo-sm h-20 align-middle inline-block"
                    height="100%">
            </span>
            <span>
                        ...
                        <div id="Admin-flush" class="hidden  overflow-hidden">
                            <ul class="nav flex-col flex flex-wrap ps-0 mb-0 ms-2">
                                <li class="nav-item relative block">
                                    ...
                                    <a href="{{ route('admin-home.index') }}" <a href="{{ route('admin.statistics') }}"
