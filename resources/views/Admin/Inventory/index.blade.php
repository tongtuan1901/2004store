        ...
        <div class="flex mb-4">
            ...
            <div class="ml-4 flex items-end">
                <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">Lọc</button>
                            ...
                            <div class="mb-4">
                            <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">  <button>  <a href="{{ route('inventory.create') }}" class="inline-flex items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700">
            Thêm Bản Ghi Tồn Kho
        </a> </button> </div>
    </div>
                                    ...
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                ...
                                                <th class="sherah-table__column-3 sherah-table__h3">Danh mục</th>
                                                <th class="sherah-table__column-4 sherah-table__h4">Biến thể sản phẩm</th>
                                                <th class="sherah-table__column-5 sherah-table__h5">Thay đổi sản phẩm</th>
                                                <th class="sherah-table__column-7 sherah-table__h6">Ghi chú</th>
                                                <th class="sherah-table__column-8 sherah-table__h7">Thời gian</th>
                                                <th class="sherah-table__column-9 sherah-table__h8">Hoạt động</th>
                                            </tr>
                                        </thead>
                                                ...
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__vendor">
                                                        <h4 class="sherah-table__vendor--title"><a
                                                                href='vendor-profile.html'>{{ $index + 1 }}</a></h4>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-3 sherah-table__data-3">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"> {{ $log->product ? $log->product->name : 'Không có sản phẩm' }}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"> {{ $log->product && $log->product->category ? $log->product->category->name : 'Không có danh mục' }}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">  @if ($log->variation)
            ...
            @endif</p>
                                                ...
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"> {{ $log->quantity_change }}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"> {{ $log->note ?? 'Không có ghi chú' }}</p>
                                                    </div>
                                                </td>

                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"> {{ $log->created_at->format('d/m/Y H:i:s') }}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-7 sherah-table__data-7">
    <div class="sherah-table__status__group">
        <a href="{{ route('inventory.edit', $log->id) }}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
        ...
        <form action="{{ route('inventory.destroy', $log->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
            <button type="submit" class="sherah-table__action sherah-color2 sherah-color2__bg--offset" onclick="return confirm('Bạn có chắc chắn muốn xóa bản ghi này không?');">
