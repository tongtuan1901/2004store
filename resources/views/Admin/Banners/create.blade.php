                        ...
                        <div class="">
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    <h1 class="font-medium text-3xl block dark:text-slate-100">Them banner</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full relative mb-4">  
                      <form action="{{route('admin-banners.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex-auto p-0 md:p-4">                                   
                            ...
                            <div class="mb-2">
                                <button type="submit" class="px-2 py-2 lg:px-4 bg-brand  text-white text-sm  rounded hover:bg-brand-600 border border-brand-500">Thêm banner</button>
