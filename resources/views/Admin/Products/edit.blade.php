                ...
                <div class="sherah-body">
                    ...
                    <div class="sherah-dsinner">
                        ...
                        <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0 container-fluid">
                            <form class="sherah-wc__form-main" action="{{ route('admin-products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group__input">
                                                            <input class="sherah-wc__form-input" type="text" name="name" value="{{ old('name', $product->name) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="sherah-wc__form-input" type="number" name="price" value="{{ old('price', $product->price) }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label class="sherah-wc__form-label">Giá khuyến mãi</label>
                                                        <input class="sherah-wc__form-input" type="number" name="price_sale" value="{{ old('price_sale', $product->price_sale) }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="flex-container">
                                                            <div id="image-preview-container" class="image-preview-container">
                                                                @foreach ($product->images as $image)
                                                                    <img src="{{ asset('storage/' . $image->path) }}" class="uploaded-image">
                                                                @endforeach
                                                            </div>
                                                            <input type="file" name="images[]" id="input-img" multiple accept="image/*">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <button type="button" id="add-variation" class="btn btn-primary mt-3">Thêm Biến Thể</button>
                                                </div>
                                            </div>
                                            <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                                <button type="submit" class="sherah-btn sherah-btn__primary">Lưu sản phẩm</button>
                                                <a class="sherah-btn sherah-btn__third" href="{{ route('admin-products.index') }}">
                                                    Cancel
                                                </a>
                                            </div>
                                        </form>
