                                        ...
                                        <div class="col-12">
                                            <div class="product-form-box sherah-border mg-top-30">
                                                            ...
                                                            <div class="flex-container">
                                                                <div id="image-preview-container" class="image-preview-container">
                                                                    @foreach ($product->images as $index => $image)
                                                                        @if ($index === 0) <!-- Chỉ hiển thị ảnh đầu tiên -->
                                                                            <img src="{{ asset('storage/' . $image->image_path) }}" class="uploaded-image">
                                                                        @endif
                                                                    @endforeach
                                                                </div>
                                                                <div class="upload-section">
                                                                    <input type="file" name="images[]" class="btn-check" id="input-img" multiple accept="image/*">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit" class="   ">Lưu sản
                                                        phẩm</button>
