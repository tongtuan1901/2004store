                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="sherah-breadcrumb mg-top-30">
                                        <h2 class="sherah-breadcrumb__title">Danh sách màu sắc</h2>
                                    </div>
                                </div>
                                <div style="display: flex; justify-content: flex-end;">
                                    <a href="{{ route('admin-color.create') }}" class="sherah-btn sherah-gbcolor">Thêm
                                        mới</a>
                                </div>
                            </div>
                                    ...
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                ...
                                                <th class="sherah-table__column-2 sherah-table__h2">Tên màu sắc</th>
                                                <th class="sherah-table__column-9 sherah-table__h8">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody class="sherah-table__body">
                                            @forelse ($listColors as $key => $color)
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__vendor">
                                                            <h4 class="sherah-table__vendor--title">{{ $color->color }}</h4>
                                                        </div>
                                                    </td>
                                                    <td class="sherah-table__column-8 sherah-table__data-8">
                                                        <div class="sherah-table__status__group">
                                                            ...
                                                            <form action="{{ route('admin-color.destroy', $color->id) }}"
                                                                    ...
                                                                    <svg class="sherah-color2__fill"
                                                                        ...
                                                                        <g id="Icon"
                                                                            ...
                                                                            <path id="Path_486" data-name="Path 486"
                                                                                d="M225.582,107.622c0,.9,0,1.806,0,2.709a.806.806,0,0,1-.917.828.825.825,0,0,1-.825-.866c0-.879,0-1.758,0-2.637,0-.68.365-1.021.97-1.021s.967.338.967,1.021Zm-1.679-2.049a.885.885,0,0,1-.895.91.893.893,0,0,1-.9-.908.884.884,0,0,1,.9-.92A.887.887,0,0,1,224.9,105.573Zm-2.113,7.77a.9.9,0,0,1-.886-.9c0-.877.44-1.247,1.247-1.247s1.237.366,1.237,1.239-.375,1.243-1.2,1.243a.85.85,0,0,1-.867-.883ZM226.948,108.1a.884.884,0,0,0-.886.886.887.887,0,0,0,.886.892c.479,0,.9-.407.9-.892a.878.878,0,0,0-.9-.889Zm0,1.21c-.164,0-.315.156-.315.307a.313.313,0,0,0,.315.315c.183,0,.308-.154.308-.315s-.125-.307-.308-.307Z"
                                                                                transform="translate(-56.069 -43.248)" />
                                                                        </g>
                                                                    </svg>
                                                                </button>
                                                            </form>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="4" class="text-center">Không có màu sắc nào</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
