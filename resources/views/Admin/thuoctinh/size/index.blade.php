                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="sherah-breadcrumb mg-top-30">
                                        <h2 class="sherah-breadcrumb__title">Danh sách kích thước</h2>
                                    </div>
                                </div>
                                <div style="display: flex; justify-content: flex-end;">
                                    <a href="{{ route('admin-size.create') }}" class="sherah-btn sherah-gbcolor">Thêm
                                        mới</a>
                                </div>
                            </div>
                                    ...
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                ...
                                                <th class="sherah-table__column-2 sherah-table__h2">Tên kích thước</th>
                                                <th class="sherah-table__column-9 sherah-table__h8">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody class="sherah-table__body">
                                            @forelse ($listSizes as $key => $size)
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__vendor">
                                                            <h4 class="sherah-table__vendor--title">{{ $size->size }}</h4>
                                                        </div>
                                                    </td>
                                                    <td class="sherah-table__column-8 sherah-table__data-8">
                                                        <div class="sherah-table__status__group">
                                                            ...
                                                            <form action="{{ route('admin-size.destroy', $size->id) }}"
                                                                    ...
                                                                    <svg class="sherah-color2__fill"
                                                                        ...
                                                                        <g id="Icon"
                                                                            ...
                                                                            <path id="Path_486" data-name="Path 486"
                                                                                d="M225.582,107.622c0,.9,0,1.806,0,2.709a.806.806,0,0,1-.917.828.825.825,0,0,1-.825-.866c0-.879,0-1.758,0-2.637,0-.68.365-1.021.97-1.021s.967.338.967,1.021Zm-1.679-2.049a.885.885,0,0,1-.895.91.893.893,0,0,1-.9-.908.884.884,0,0,1,.9-.91A.888.888,0,0,1,224.9,105.575Z"
                                                                                transform="translate(-56.232 -75.787)" />
                                                                        </g>
                                                                    </svg>
                                                                </button>
                                                            </form>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center">Không có kích thước nào</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
